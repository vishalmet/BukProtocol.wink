...
const SucessConfirmation = ({tokenID}) => {
  ...
  return (
    ...
    <div className="relative md:w-[500px] md:h-[500px] sm:h-[350px] sm:w-[300px] bg-[#161616] shadow-lg p-2 flex flex-col items-center">
      <div
        className="relative shadow-lg md:w-[485px] md:h-[230px] sm:h-[160px] sm:w-[300px]  p-6 flex flex-col justify-between"
        style={{
      ...
      >
        ...
        <div className='md:mt-48 sm:mt-32 items-center justify-center flex flex-col text-center'>
         ...
         <a href={`https://polygon.dassets.xyz/hotels/nft-details?nftId=${tokenID}`} className="bg-[#CA3F2A] text-white md:px-[40px] md:mt-8 sm:px-[30px] sm:mt-2 py-1 rounded-md md:text-lg sm:text-xs border-[#FFE3E3] border border-opacity-50   "
          >
           Check my Bookings
          </a>
